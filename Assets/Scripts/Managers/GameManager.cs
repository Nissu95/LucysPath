...
#pragma warning disable 649
    ...
    string starStringText;
    string maxStarStringText;
...
#pragma warning disable 649
    ...
    public void ChangeLanguge()
    {
        switch (language)
        {
            case SystemLanguage.English:
                ...
                starStringText = english.GetStarsText();
                maxStarStringText = english.GetMaxStarsText();
            ...
            case SystemLanguage.Spanish:
                ...
                starStringText = spanish.GetStarsText();
                maxStarStringText = spanish.GetMaxStarsText();
    ...
    public void LevelWin()
    {
        ...
        starText.text = starStringText + stars;
        maxStarsText.text = maxStarStringText + recordStars;
